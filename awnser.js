...
const convert = ({ unit: from, value: currentValue, conversionTo }) => {
  let result = 0;
  ...
  const currentValueToConvert = conversionValues[from][conversionTo]
  result = currentValue * currentValueToConvert
